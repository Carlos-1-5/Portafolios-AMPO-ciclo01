...
int main(){
	vector<string> jugadores = {"Erick", "Emmanuel", "Briam", "Gabriel", "Maria", "Oscar", "Krita", "Eduardo", "Alejandra", "carlos",
								"Diego", "manuel", "jose", "mateo", "fernando", "martinez", "ernesto", "Gustavo", "graham"};
